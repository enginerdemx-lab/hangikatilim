                              ...
                              <div className="w-full md:w-auto flex-shrink-0 flex flex-col gap-2">
                                 {camp.application_link && (
                                    <a
                                       ...
                                       target="_blank"
                                       rel="noreferrer"
                                       className="w-full bg-white dark:bg-slate-700 border-2 border-[#ff6f00] text-[#ff6f00] hover:bg-[#ff6f00] hover:text-white font-bold py-2.5 px-6 rounded-lg transition-all text-sm text-center"
                                    >
