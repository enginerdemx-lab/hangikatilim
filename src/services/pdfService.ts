                  ...
                  <tr style="background: ${row.isDeliveryMonth ? '#d1fae5' : idx % 2 === 0 ? '#f8fafc' : 'white'};">
                    <td style="padding: 6px 4px; border: 1px solid #e2e8f0; text-align: center; font-weight: ${row.isDeliveryMonth ? '700' : '400'}; font-size: 9px;">
                      <div style="display: flex; flex-direction: column; align-items: center; gap: 1px;">
                        <span>${row.month}</span>
                        ${row.isDeliveryMonth ? '<span style="display: inline-block; background: #10b981; color: white; padding: 1px 4px; border-radius: 3px; font-size: 6px; line-height: 1.4; text-align: center; margin-top: 2px; max-width: 100%; overflow: hidden; white-space: nowrap; letter-spacing: 0.5px;">TESLİM</span>' : ''}
                      </div>
                    </td>
