-- FIX ADMIN FUNCTIONS AFTER SECURITY UPDATE
-- Run this in Supabase SQL Editor to restore admin functionality

-- =====================================================
-- 1. FIX: get_all_users_admin (Main user listing function)
-- =====================================================
...
-- =====================================================
-- 2. FIX: update_user_status_admin
-- =====================================================

DROP FUNCTION IF EXISTS public.update_user_status_admin CASCADE;
...
-- =====================================================
-- 3. FIX: update_user_admin
-- =====================================================

DROP FUNCTION IF EXISTS public.update_user_admin CASCADE;
...
-- =====================================================
-- 4. FIX: remove_user_avatar_admin
-- =====================================================

DROP FUNCTION IF EXISTS public.remove_user_avatar_admin CASCADE;
...
-- =====================================================
-- 7. FIX: log_user_login trigger function
-- =====================================================
...
-- =====================================================
-- 8. FIX: get_user_login_history
-- =====================================================

DROP FUNCTION IF EXISTS public.get_user_login_history CASCADE;
...
SELECT * FROM public.get_all_users_admin() LIMIT 5;
