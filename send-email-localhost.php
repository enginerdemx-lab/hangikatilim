<?php
/**
 * E-POSTA API - LOCALHOST SMTP
 * Natro shared hosting için optimize edilmiş
 */
...
// SMTP - localhost kullan (aynı sunucu)
$host = 'localhost';
$port = 25;
...
if (!$fp) {
    die(json_encode(['success' => false, 'error' => "Connection: $errstr"]));
}
