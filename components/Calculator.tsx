...
export const Calculator: React.FC<CalculatorProps> = ({ 
  ...
  // Schedule Accordion State - Default CLOSED as requested
            ...
            <div className="bg-gray-50 dark:bg-slate-900 p-1.5 rounded-xl flex mb-8 shadow-inner border border-gray-100 dark:border-slate-800">
              <button
                ...
                className={`flex-1 py-3 px-4 rounded-lg text-sm font-bold flex items-center justify-center gap-2 transition-all ${
                  params.systemType === SystemType.LOTTERY
                ...
                <div className="flex items-center gap-2">
                   ...
                   <div className="relative w-24">
                    <input
                      ...
                      className={`w-full pl-2 pr-8 py-2 border rounded-lg outline-none text-center text-lg font-bold transition-all ${
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full pl-4 pr-12 py-3 border rounded-lg outline-none text-lg font-bold transition-all ${
                      params.calculationMode === 'BY_INSTALLMENT' 
                        ? 'border-primary-500 ring-2 ring-primary-100 dark:ring-primary-900 text-primary-900 dark:text-white bg-white dark:bg-slate-800' 
                        : 'border-gray-300 dark:border-slate-600 text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-slate-900 hover:bg-white dark:hover:bg-slate-800 focus:bg-white dark:focus:bg-slate-800'
                    }`}
              ...
              <div className="grid grid-cols-3 gap-3">
                <button
                  ...
                  className={`py-2 px-2 rounded-lg text-xs font-bold border transition-all ${
                    params.feePaymentType === FeePaymentType.UPFRONT
                ...
                <button
                  ...
                  className={`py-2 px-2 rounded-lg text-xs font-bold border transition-all ${
                    params.feePaymentType === FeePaymentType.SPLIT_HALF
                      ? 'bg-primary-50 dark:bg-primary-900/20 border-primary-500 text-primary-700 dark:text-primary-400'
                      : 'border-gray-200 dark:border-slate-700 text-gray-500 dark:text-gray-400 hover:border-primary-300'
                  }`}
                >
                ...
                <button
                  ...
                  className={`py-2 px-2 rounded-lg text-xs font-bold border transition-all ${
                    params.feePaymentType === FeePaymentType.SPREAD
                      ? 'bg-primary-50 dark:bg-primary-900/20 border-primary-500 text-primary-700 dark:text-primary-400'
                      : 'border-gray-200 dark:border-slate-700 text-gray-500 dark:text-gray-400 hover:border-primary-300'
                  }`}
                >
                    ...
                    {result.schedule.map((row) => (
                      <tr 
                        ...
                        className={`hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors ${
                          row.isDeliveryMonth ? 'bg-primary-50/50 dark:bg-primary-900/10' : ''
                        }`}
                      >
                              ...
                              <div className="mt-1">
                                  {row.isDeliveryMonth ? (
                                    ...
                                    <span className={`text-[10px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded border ${
                                      row.month > result.deliveryMonthIndex 
