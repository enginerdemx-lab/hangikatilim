        ...
        return (
          <>
            <div className="container mx-auto px-4 pt-4">
              <section className="relative bg-[linear-gradient(90deg,#4DC9E6,#210CAE)] text-white overflow-hidden transition-colors duration-300 rounded-2xl shadow-xl">
                ...
                <div className="container mx-auto px-4 py-8 md:py-12 relative z-10">
                  <div className="max-w-3xl">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-medium text-white mb-3 animate-fade-in-up backdrop-blur-sm">
                      <span className="w-2 h-2 rounded-full bg-white animate-pulse"></span>
                      Hangi Katılım ile Geleceği Planla
                    </div>
                    <h1 className="text-2xl md:text-4xl font-bold leading-tight mb-3 tracking-tight">
                    ...
                    <p className="text-sm md:text-base text-gray-100 mb-6 max-w-2xl leading-relaxed opacity-90">
                    ...
                    <div className="flex flex-wrap gap-3">
                      <a
                        ...
                        className="bg-white text-[#210CAE] font-bold px-5 py-2.5 rounded-xl shadow-lg flex items-center justify-center gap-2 transition-all transform hover:scale-105 text-sm"
                      >
                        Plan Oluştur
                        <ArrowRight size={16} />
                      </a>
                      <a
                        ...
                        className="bg-white/10 hover:bg-white/20 text-white border border-white/20 font-bold px-5 py-2.5 rounded-xl flex items-center justify-center gap-2 transition-all transform hover:scale-105 text-sm backdrop-blur-sm"
                      >
                        Sistem Nedir?
                        <Info size={16} />
                      </a>
